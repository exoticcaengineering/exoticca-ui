...
const rebrandPalette: RebrandPalette = {
  polarNight: '#121212',
  polarNightDark: '#5B5B5B',
  polarNightMedium: '#717171',
  polarNightLighter: '#D8D8D8',
  polarNightLight: '#E5E5E5',
  polarNightExtraLight: '#F3F3F3',
  arcticWind: '#ffffff',
  pacificOceanExtraLight: '#F0F7FE',
  pacificOceanLight: '#CEE4FD',
  pacificOceanLighter: '#CDE3FD',
  pacificOceanMedium: '#95C2F3',
  pacificOceanDark: '#4573A5',
  pacificOcean: '#68ACF8',
  savageForestExtraLight: '#F0FAF1',
  savageForestLight: '#D8F3DB',
  savageForestLighter: '#CCEFD0',
  savageForestMedium: '#95DE9C',
  savageForestDark: '#458B4B',
  savageForest: '#67D071',
  silentSavanaExtraLight: '#FEFBED',
  silentSavanaLight: '#FBE693',
  silentSavanaLighter: '#FDF1C2',
  silentSavanaMedium: '#FFE375',
  silentSavanaDark: '#A58D2F',
  silentSavana: '#F8D447',
  carribeanSunriseExtraLight: '#FEF1EB',
  carribeanSunriseLight: '#FCDECF',
  carribeanSunriseLighter: '#FBD2BD',
  carribeanSunriseMedium: '#F6A57E',
  carribeanSunriseDark: '#A14F27',
  carribeanSunrise: '#F2773B',
  redDessertExtraLight: '#FAEBEE',
  redDessertLight: '#F7BAC7',
  redDessertLighter: '#EDBDC7',
  redDessertMedium: '#F5708D',
  redDessertDark: '#86263A',
  redDessert: '#C93957',
  success: '#67D071',
  pending: '#F8D447',
  error: '#F2773B',
...
export const palette: Palette = {
  primary: {
    ...
    extraLight: rebrandPalette.polarNightExtraLight,
    light: rebrandPalette.polarNightLight,
    lighter: rebrandPalette.polarNightLighter,
    medium: rebrandPalette.polarNightMedium,
    dark: rebrandPalette.polarNightDark,
  ...
  promotion: {
    ...
    extraLight: rebrandPalette.carribeanSunriseExtraLight,
    light: rebrandPalette.carribeanSunriseLight,
    lighter: rebrandPalette.carribeanSunriseLighter,
    medium: rebrandPalette.carribeanSunriseMedium,
    dark: rebrandPalette.carribeanSunriseDark,
    contrast: rebrandPalette.polarNight,
  },
  background: {
    main: rebrandPalette.arcticWind,
  ...
  success: {
    ...
    extraLight: rebrandPalette.savageForestExtraLight,
    light: rebrandPalette.savageForestLight,
    lighter: rebrandPalette.savageForestLighter,
    medium: rebrandPalette.savageForestMedium,
    dark: rebrandPalette.savageForestDark,
    contrast: rebrandPalette.polarNight,
  },
  warning: {
    main: rebrandPalette.redDessert,
    extraLight: rebrandPalette.redDessertExtraLight,
    light: rebrandPalette.redDessertLight,
    lighter: rebrandPalette.redDessertLighter,
    medium: rebrandPalette.redDessertMedium,
    dark: rebrandPalette.redDessertDark,
    contrast: rebrandPalette.arcticWind,
  },
  rating: {
    main: rebrandPalette.polarNight,
  ...
  info: {
    ...
    extraLight: rebrandPalette.pacificOceanExtraLight,
    light: rebrandPalette.pacificOceanLight,
    lighter: rebrandPalette.pacificOceanLighter,
    medium: rebrandPalette.pacificOceanMedium,
    dark: rebrandPalette.pacificOceanDark,
    contrast: rebrandPalette.polarNight,
  },
};
