...
const SvgTravelBaggage = ({
  ...
  >
    ...
    <path
      ...
      strokeWidth={5}
      d="M72.25 102.375h-42.5c-4.696 0-8.5-4.363-8.5-9.75v-48.75c0-5.387 3.804-9.75 8.5-9.75h42.5c4.696 0 8.5 4.363 8.5 9.75v48.75c0 5.387-3.804 9.75-8.5 9.75"
      clipRule="evenodd"
    />
    <path
      stroke="currentColor"
...
export default WithIconWrapper(SvgTravelBaggage);
