  ...
  ({
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="m14.24 13.583 1.748-5.243a.26.26 0 0 0-.328-.329L10.417 9.76c-.31.103-.554.347-.657.657l-1.748 5.243a.26.26 0 0 0 .329.328l5.243-1.748c.31-.103.553-.346.656-.656v0"
        clipRule="evenodd"
      />
      <path
        stroke="#121212"
