...
export const iconComponents: Record<IconName, FC<SVGProps<SVGSVGElement>>> = {
  ...
  'play-store-icon-de': PlayStoreDE,
  'play-store-icon-en': PlayStoreEN,
  'play-store-icon-es': PlayStoreES,
  'play-store-icon-fr': PlayStoreFR,
  'play-store-icon-mx': PlayStoreMX,
  'app-store-icon-de': AppStoreDE,
  'app-store-icon-en': AppStoreEN,
  'app-store-icon-es': AppStoreES,
  'app-store-icon-fr': AppStoreFR,
