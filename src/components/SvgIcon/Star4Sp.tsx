...
const SvgStar4Sp = ({
  ...
  >
    ...
    <path
      fill="currentColor"
      d="M118.578 21.22c-3.432 0-5.72-2.222-5.962-4.906h1.914c.264 1.496 1.474 3.058 4.092 3.058 2.222 0 3.916-.946 3.938-2.882 0-2.09-2.354-2.728-4.466-3.476-2.42-.836-4.972-1.76-4.972-4.422 0-2.838 2.75-4.312 5.5-4.312 3.586 0 5.346 1.826 5.808 4.532h-1.76c-.198-1.43-1.518-2.86-4.026-2.86-1.672 0-3.52.792-3.52 2.53 0 1.694 2.046 2.354 3.982 3.102 2.376.924 5.434 1.76 5.434 4.84 0 3.124-2.838 4.796-5.962 4.796ZM128.45 4.5h6.82c2.574 0 4.62 2.332 4.62 4.906s-2.046 4.862-4.62 4.862h-4.884V21h-1.936V4.5Zm1.936 8.14h4.752c1.628 0 2.992-1.496 2.992-3.212 0-1.694-1.364-3.212-2.992-3.212h-4.752v6.424Z"
    />
  </svg>
);
export default SvgStar4Sp;
