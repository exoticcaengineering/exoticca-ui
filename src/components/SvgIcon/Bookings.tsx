...
const SvgBookings = ({
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m12.5 18-3.707 3.707a1 1 0 0 1-.707.293H7.002a1 1 0 0 1-.889-1.46L7.427 18H5.055a2 2 0 0 1-1.897-1.367l-1.106-3.317A1 1 0 0 1 3.001 12h.995a1 1 0 0 1 .894.553L5.614 14H16a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-3.5Z"
      clipRule="evenodd"
    />
  </svg>
);
