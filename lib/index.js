...
var mapCssPxValue = function () {
    ...
    if (length < 1 || length > 4)
        return '0px';
    return args.map(function (value) { return "".concat(value, "px"); }).join(' ');
};
...
var StyledBoxWrapper = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  background: ", ";\n  border-radius: ", ";\n  border-width: ", ";\n  border-style: ", ";\n  border-color: ", ";\n  box-shadow: ", ";\n  margin-bottom: ", ";\n  padding: ", ";\n"], ["\n  background: ", ";\n  border-radius: ", ";\n  border-width: ", ";\n  border-style: ", ";\n  border-color: ", ";\n  box-shadow: ", ";\n  margin-bottom: ", ";\n  padding: ", ";\n"])), function (_a) {
    var theme = _a.theme, _b = _a.background, background = _b === void 0 ? 'transparent' : _b;
    return theme.colors[background];
}, function (_a) {
    var theme = _a.theme, _b = _a.borderRadius, borderRadius = _b === void 0 ? 's' : _b;
    if (Array.isArray(borderRadius)) {
        return borderRadius.map(function (radius) { return theme.borderRadius[radius]; }).join(' ');
    }
    return theme.borderRadius[borderRadius];
}, function (_a) {
    var _b = _a.borderWidth, borderWidth = _b === void 0 ? [1] : _b;
    if (Array.isArray(borderWidth)) {
        return mapCssPxValue.apply(void 0, borderWidth);
    }
    return "".concat(borderWidth, "px");
}, function (_a) {
    var _b = _a.borderStyle, borderStyle = _b === void 0 ? 'solid' : _b;
    return borderStyle;
}, function (_a) {
    var theme = _a.theme, _b = _a.borderColor, borderColor = _b === void 0 ? 'transparent' : _b;
    return theme.colors[borderColor];
}, function (_a) {
    var theme = _a.theme, _b = _a.boxShadow, boxShadow = _b === void 0 ? 'none' : _b;
    return theme.boxShadow[boxShadow];
}, function (_a) {
    var theme = _a.theme, _b = _a.gutterBottom, gutterBottom = _b === void 0 ? 0 : _b;
    return theme.spacing(gutterBottom);
}, function (_a) {
    var theme = _a.theme, _b = _a.padding, padding = _b === void 0 ? 0 : _b;
    if (Array.isArray(padding)) {
        return theme.spacing.apply(theme, padding);
    }
    return theme.spacing(padding);
});
var templateObject_1;

var Box = reactExports.forwardRef(function (_a, ref) {
    var children = _a.children, testId = _a.testId, className = _a.className, props = __rest(_a, ["children", "testId", "className"]);
    return (jsxRuntimeExports.jsx(StyledBoxWrapper, __assign({ className: className, "data-testid": testId, ref: ref }, props, { children: children })));
});

var Test = function () {
    return (jsxRuntimeExports.jsx("div", { children: "adadasdasdasdadasdsad" }));
};
